...
public class OpenDoorTerminal {
    ...
    byte currentCar = 0x01;

    CardChannel applet;

    public OpenDoorTerminal() {
        run();
    }
    ...
    void openDoor(){
    	...
    	if (data[0] == currentCar && startTime <= currentTime && endTime > currentTime ){
    		statusDoor = !statusDoor;
    	} else {
    		System.out.println("You don't have access to this car on this moment");
    	}
    	if (statusDoor){
